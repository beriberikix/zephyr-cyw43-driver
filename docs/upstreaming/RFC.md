...
- A combined CYW43439 **BT firmware blob** — needs the Zephyr west blob + EULA/governing-board path.
...
3. What is the expected path for the **BT firmware blob** (west blob + EULA / governing board)?
